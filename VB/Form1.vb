...
Namespace docITypedList
	Partial Public Class Form1
		...
		Private Function CreateProduct(ByVal supplierID As Integer, ByVal productName As String) As Product
			...
			product.OrderDetails.AddRange(New OrderDetail() { New OrderDetail(product.ProductID, random.Next(0, 100)), New OrderDetail(product.ProductID, random.Next(0, 100)), New OrderDetail(product.ProductID, random.Next(0, 100)) })
